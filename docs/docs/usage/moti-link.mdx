...
You can also reference/clone the [Solito starter app](https://github.com/nandorojo/solito/tree/master/monorepo-examples/blank) which has Moti and Solito configured for you.
