...
However, this might throw of your styling or interaction events. Chances are, you don't want to disable the button altogether. So what else can we do?
...
If you need to render a text node in your link, reference the [`<TextLink />`](/usage/link-text) docs.
