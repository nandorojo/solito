...
`StyleSheet.absoluteFill` does not play nicely with screens that have a fixed footer at the bottom, and a keyboard that needs to open. For example, a chat screen with an input at the bottom that sits above the keyboard won't respond correctly to `StyleSheet.absoluteFill`.
...
| --------------------- | ------------------------ |
| <video src="https://user-images.githubusercontent.com/13172299/166524927-dc65e795-173e-48e2-b8bf-4ccf18c935bf.mov" /> | <video src="https://user-images.githubusercontent.com/13172299/166524954-7ba65b5a-c4c7-4817-aae2-3689c24ba5a6.MP4" /> |
