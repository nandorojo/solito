...
This is essentially what the new source code for `solito/link` looks like:
...
> The breaking changes + upgrade guide for Solito 5 are spiritually similar to those of Zeego 2. If you're interested, you can reference [that guide](https://github.com/nandorojo/zeego/releases/tag/v2.0.0) too.
