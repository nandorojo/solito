...
I later spoke at App.js Conf in June 2022 about Solito, its reception, and the release of [zeego](https://github.com/nandorojo/zeego), a cross-platform menu library I built inspired by Radix UI.
