...
:::tip Solito reached #3 on Hackernews
A few hours after launching, Solito reached #3 on the front page of Hackernews. Check out the [post here](https://news.ycombinator.com/item?id=30678100).
:::
